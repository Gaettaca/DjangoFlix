...
from .models import MovieProxy, TVShowSeasonProxy, TVShowProxy, Playlist, PlaylistItem
...
class PlaylistAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        return Playlist.objects.filter(type=Playlist.PlaylistTypeCoices.PLAYLIST)
